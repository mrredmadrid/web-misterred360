...
const es: Dict = {
  ...
  "page.man.title": "La comunicación\nal *servicio de tu marca.*",
  "page.man.intro": "No queremos hablar de nosotros, queremos hablar de ti para ayudarte a crecer.",

  "page.why.seo.title": "Por Qué Nosotros — Agencia de Comunicación 360 | MISTERRED360",
  "page.why.seo.desc": "Piensa diferente, actúa diferente, redescubre tu camino. Por qué trabajar con MISTERRED360: un interlocutor único, trajes a medida, instinto con método y alta eficacia 24/7/365.",
  "page.why.kicker": "Por qué nosotros",
  "page.why.meta": "4 diferenciales · 1 método",
  "page.why.title": "Piensa diferente. Actúa diferente.\n*Redescubre tu camino.*",
  "page.why.intro": "Trabajamos con pocos clientes. Por eso trabajamos bien. Un interlocutor. El mismo siempre. Localizable el día 3, no el día 30. 360 grados de cobertura. Cero grados de distancia.",
  "page.why.close.kicker": "Hablemos",
  "page.why.close.title": "¿Empezamos a marcar\nla {red}diferencia?{/red}",
  "page.why.close.p": "Cuéntanos tu reto y te decimos, sin humo, cómo encaja con nuestra forma de trabajar.",
  "page.why.close.cta": "Cuéntanos tu reto",
  "page.man.quote": "Ponemos el {red}alma{/red}\nen cada proyecto.",
  "page.man.p1": "Somos la agencia que no cabe en un briefing. Una agencia convencional te asigna un ejecutivo de cuentas. Nosotros te asignamos profesionales comprometidos contigo que se implican y dejan el alma en cada proyecto.",
  ...
  "page.ai.capabilities_title": "Un aliado que no descansa, pero que sí escucha y nos ayuda a generar nuevas oportunidades",
  ...
  "page.met.close.cta": "Quiero marcar la diferencia",
  ...
  "page.ele.h.title": "Profesionales con dilatada experiencia en {red}comunicación, imagen y RRPP, marketing, estrategia corporativa, diseño web y programación.{/red}",
...
const en: Dict = {
  ...
  "page.man.title": "Communication\nat the *service of your brand.*",
  "page.man.intro": "We don't want to talk about ourselves — we want to talk about you, to help you grow.",

  "page.why.seo.title": "Why Us — 360 Communication Agency | MISTERRED360",
  "page.why.seo.desc": "Think different, act different, rediscover your path. Why work with MISTERRED360: a single point of contact, made to measure, instinct with method and high efficiency 24/7/365.",
  "page.why.kicker": "Why us",
  "page.why.meta": "4 differentials · 1 method",
  "page.why.title": "Think different. Act different.\n*Rediscover your path.*",
  "page.why.intro": "We work with few clients. That's why we work well. One point of contact. Always the same. Reachable on day 3, not day 30. 360 degrees of coverage. Zero degrees of distance.",
  "page.why.close.kicker": "Let's talk",
  "page.why.close.title": "Shall we start making\nthe {red}difference?{/red}",
  "page.why.close.p": "Tell us your challenge and we'll tell you, no smoke, how it fits our way of working.",
  "page.why.close.cta": "Tell us your challenge",
  "page.man.quote": "We put our {red}soul{/red}\ninto every project.",
  "page.man.p1": "We're the agency that doesn't fit in a brief. A regular agency assigns you an account manager. We assign you committed professionals who get involved and put their soul into every project.",
  ...
  "page.ai.capabilities_title": "An ally that never rests, but always listens and helps us find new opportunities",
  ...
  "page.met.close.cta": "I want to make a difference",
  ...
  "page.ele.h.title": "Seasoned professionals in {red}communication, image and PR, marketing, corporate strategy, web design and development.{/red}",
