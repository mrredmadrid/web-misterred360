...
const es: Dict = {
  ...
  "hero.badge": "Contesta una persona. Con nombre.",
  "hero.scroll": "Scroll",
  ...
  "manifesto.title": "Ponemos el *alma.*\nMedimos al milímetro.",
  "manifesto.eco": "Somos la agencia que no cabe en un briefing.",
  "manifesto.p1":
    "Una agencia convencional te asigna un ejecutivo de cuentas. Nosotros te asignamos una obsesión. Una agencia convencional tiene un método y te mete dentro; nosotros medimos tu negocio al milímetro y construimos el método alrededor.",
  "manifesto.p2":
    "Hacemos comunicación como se hacía antes —hablando contigo, escuchándote, entendiéndote— con las herramientas de ahora. 360 grados de cobertura. Cero grados de distancia.",
  ...
  "sblock.comunicacion.title": "Reputación",
  "sblock.comunicacion.claim": "Que hablen bien de ti. Y en el lugar correcto.",
  "sblock.comunicacion.desc":
    "La credibilidad no se compra en anuncios. Se construye en prensa, en instituciones y en los diez minutos antes de la entrevista. Aquí empieza todo.",
  "sblock.identidad.title": "Identidad",
  "sblock.identidad.claim": "Cómo te reconocen antes de que te presentes.",
  "sblock.identidad.desc":
    "Tu marca ya dice algo de ti. La pregunta es si dice lo que tú quieres. Identidad, naming y posicionamiento sin plantillas ni degradados.",
  "sblock.difusion.title": "Creación y Difusión",
  "sblock.difusion.claim": "Lo que la gente ve, comparte y recuerda.",
  "sblock.difusion.desc":
    "Audiovisual, publicidad, eventos y digital que no se olvidan. Un anuncio que no se recuerda es un gasto. Uno que se recuerda es una inversión.",
  ...
  "footer.slogan": "Comunicación que da la vuelta a tu marca",
  ...
  "page.man.quote": "«No hacemos ruido:\nhacemos {red}eco{/red}.»",
  "page.man.p1": "MISTERRED360 nace de una convicción simple y exigente: {b}la mayoría de las marcas no tienen un problema de producto, tienen un problema de relato.{/b} Trabajan, innovan y crecen en silencio mientras otras, con menos que contar, ocupan toda la conversación. Nuestro trabajo es darle la vuelta a esa ecuación.",
  "page.man.p2": "Por eso no vendemos servicios sueltos: diseñamos ecosistemas de comunicación donde la estrategia manda, la creatividad sorprende y los resultados se miden. Todo gira. Todo suma. Todo se escucha.",
  ...
  "page.man.socio.q": "«El mono observa, piensa y habla. En ese orden.»",
  ...
  "page.srv.meta": "8 servicios · 3 bloques · 1 visión",
  "page.srv.title": "Todo lo que tu marca\nnecesita para *hacerse oír.*",
  "page.srv.intro": "Ocho especialidades organizadas en tres bloques con una única dirección estratégica: la comunicación es el núcleo; la identidad y la difusión orbitan a su alrededor.",
  "page.srv.figure_alt": "El Publicista: el chimpancé de MISTERRED360 con un megáfono rojo",
  ...
  "service.gabinete-de-prensa.long": "Convertimos la actividad de tu empresa, institución o proyecto en mensajes con valor informativo para que tu trabajo gane visibilidad, reputación y presencia pública. Diseñamos acciones de comunicación, elaboramos contenidos periodísticos y trabajamos la relación con medios para transformar tu actividad en noticia y posicionarte donde de verdad importa.",
  "service.planificacion-estrategica.name": "Planificación Estratégica",
  "service.planificacion-estrategica.tag": "La hoja de ruta.",
  "service.planificacion-estrategica.brief": "Diseñamos planes de comunicación claros y eficaces para alinear mensajes, canales y objetivos con una visión global.",
  "service.planificacion-estrategica.long": "Toda comunicación eficaz necesita una hoja de ruta clara. Diseñamos planes de comunicación estructurados, realistas y alineados con tus objetivos para ordenar mensajes, priorizar canales y coordinar cada acción con una visión global de marca.",
  "service.comunicacion-2-0.name": "Comunicación 2.0",
  "service.comunicacion-2-0.tag": "La conversación nunca duerme.",
  "service.comunicacion-2-0.brief": "Integramos redes sociales y comunicación digital dentro de una estrategia coherente que amplifica tu mensaje y fortalece tu marca.",
  "service.comunicacion-2-0.long": "Las redes sociales no son un canal aislado, sino una extensión natural de la estrategia de comunicación. Integramos la comunicación digital en el plan global de marca para amplificar mensajes, fortalecer la conversación con la audiencia y generar una presencia coherente en todos los entornos online.",
  "service.rrpp-eventos.name": "RRPP y Eventos",
  "service.rrpp-eventos.tag": "Presencia que se recuerda.",
  "service.rrpp-eventos.brief": "Diseñamos acciones y eventos que refuerzan relaciones, multiplican la difusión y proyectan tu mensaje con más fuerza.",
  "service.rrpp-eventos.long": "Las relaciones públicas amplían el alcance del mensaje y refuerzan la reputación de la marca en entornos clave. Diseñamos acciones de relación institucional, networking y organización de eventos con una coordinación personalizada para multiplicar la difusión, generar conexiones de valor y dar relevancia a cada iniciativa.",
  "service.imagen-corporativa.name": "Imagen Corporativa",
  "service.imagen-corporativa.tag": "Identidad con carácter.",
  "service.imagen-corporativa.brief": "Creamos o redefinimos tu identidad visual para que refleje con claridad la esencia y el valor de tu actividad.",
  "service.imagen-corporativa.long": "La imagen de una marca debe expresar con claridad quién es, qué ofrece y por qué es diferente. Desarrollamos o renovamos identidades corporativas para que reflejen la esencia de tu actividad y proyecten una imagen sólida, coherente y profesional en todos tus puntos de contacto.",
  "service.creacion-audiovisual.name": "Creación Audiovisual",
  "service.creacion-audiovisual.tag": "Historias que se ven.",
  "service.creacion-audiovisual.brief": "Producimos contenidos audiovisuales que conectan, explican y potencian tus campañas, productos y canales digitales.",
  "service.creacion-audiovisual.long": "El contenido audiovisual es una de las herramientas más eficaces para captar atención, explicar valor y conectar con nuevas audiencias. Creamos piezas de vídeo personalizadas para empresas, instituciones y negocios, orientadas a reforzar campañas, presentar servicios, impulsar redes sociales y mejorar el impacto de la comunicación digital.",
  "service.publicidad-marketing.name": "Publicidad y Marketing",
  "service.publicidad-marketing.tag": "Impacto que convierte.",
  "service.publicidad-marketing.brief": "Desarrollamos campañas y mensajes orientados a maximizar visibilidad, notoriedad e impacto comercial.",
  "service.publicidad-marketing.long": "Diseñamos acciones publicitarias y campañas de marketing enfocadas a mejorar el alcance, la notoriedad y la respuesta del público. Definimos mensajes, creatividad y soportes adecuados para que cada campaña tenga coherencia estratégica y genere un impacto real en tus objetivos comerciales y de comunicación.",
  "service.estudios-de-mercado.name": "Estudios de Mercado",
  "service.estudios-de-mercado.tag": "Decidir con datos.",
  "service.estudios-de-mercado.brief": "Generamos información útil para entender mejor tu entorno y tomar decisiones estratégicas con mayor seguridad.",
  ...
  "page.ele.title": "Ocho versiones.\nUn mismo *instinto.*",
  "page.ele.intro": "Nuestro personaje no es una mascota: es el embajador visual de la marca. Cambia de rol según la misión, pero nunca de carácter. Estratégico, cercano, imposible de ignorar.",
  ...
  "page.ele.full.p": "Cada rol responde a un servicio real de la agencia. Elige con quién quieres empezar la conversación.",
  ...
  "cast.icono.role": "El Icono",
  "cast.icono.area": "Marca",
  "cast.icono.quote": "La cara visible.",
  "cast.portavoz.role": "La Portavoz",
  "cast.portavoz.area": "Prensa",
  "cast.portavoz.quote": "Da la cara por ti.",
  "cast.estratega.role": "La Estratega",
  "cast.estratega.area": "Planificación",
  "cast.estratega.quote": "Piensa tres jugadas por delante.",
  "cast.anfitrion.role": "El Anfitrión",
  "cast.anfitrion.area": "Eventos",
  "cast.anfitrion.quote": "Domina cualquier escenario.",
  "cast.disenador.role": "La Diseñadora",
  "cast.disenador.area": "Identidad",
  "cast.disenador.quote": "Detalle a detalle.",
  "cast.director.role": "El Director",
  "cast.director.area": "Audiovisual",
  "cast.director.quote": "Cuenta historias en 24 fps.",
  "cast.publicista.role": "La Publicista",
  "cast.publicista.area": "Marketing",
  "cast.publicista.quote": "Se hace oír.",
  "cast.analista.role": "El Analista",
  "cast.analista.area": "Datos",
  "cast.analista.quote": "Nada se le escapa.",
...
const en: Dict = {
  ...
  "sblock.comunicacion.title": "Reputation",
  "sblock.comunicacion.claim": "Get people talking about you. In the right room.",
  "sblock.comunicacion.desc":
    "Credibility isn't bought in ads. It's built in press, in institutions and in the ten minutes before the interview. Everything starts here.",
  "sblock.identidad.title": "Identity",
  "sblock.identidad.claim": "How people know you before you introduce yourself.",
  "sblock.identidad.desc":
    "Your brand already says something about you. The question is whether it says what you want it to say. Identity, naming and positioning with no templates and no gradients.",
  "sblock.difusion.title": "Creation and Distribution",
  "sblock.difusion.claim": "What people see, share and remember.",
  "sblock.difusion.desc":
    "Video, advertising, events and digital that stick. An ad no one remembers is an expense. One that gets remembered is an investment.",
  ...
  "footer.slogan": "Communication that turns your brand around",
  ...
  "page.man.quote": "\"We don't make noise:\nwe make {red}echo{/red}.\"",
  "page.man.p1": "MISTERRED360 comes from a simple, demanding conviction: {b}most brands don't have a product problem, they have a story problem.{/b} They work, innovate and grow in silence while others, with less to say, own the whole conversation. Our job is to flip that equation.",
  "page.man.p2": "That's why we don't sell scattered services: we design communication ecosystems where strategy leads, creativity surprises and results are measured. Everything spins. Everything adds up. Everything is heard.",
  ...
  "page.man.socio.q": "\"The monkey observes, thinks and speaks. In that order.\"",
  ...
  "page.srv.meta": "8 services · 3 blocks · 1 vision",
  "page.srv.title": "Everything your brand\nneeds to *be heard.*",
  "page.srv.intro": "Eight specialties organized in three blocks with a single strategic direction: communication is the core; identity and distribution orbit around it.",
  "page.srv.figure_alt": "The Publicist: MISTERRED360's chimp with a red megaphone",
  ...
  "service.gabinete-de-prensa.long": "We turn the activity of your company, institution or project into messages with news value so your work gains visibility, reputation and public presence. We design communication actions, produce editorial content and manage media relations to turn your activity into news and position you where it really matters.",
  "service.planificacion-estrategica.name": "Strategic Planning",
  "service.planificacion-estrategica.tag": "The roadmap.",
  "service.planificacion-estrategica.brief": "We design clear, effective communication plans that align messages, channels and objectives with a global vision.",
  "service.planificacion-estrategica.long": "Every effective communication needs a clear roadmap. We design structured, realistic communication plans aligned with your objectives to order messages, prioritize channels and coordinate every action within a global brand vision.",
  "service.comunicacion-2-0.name": "Digital Communication",
  "service.comunicacion-2-0.tag": "The conversation never sleeps.",
  "service.comunicacion-2-0.brief": "We integrate social media and digital communication into a coherent strategy that amplifies your message and strengthens your brand.",
  "service.comunicacion-2-0.long": "Social media isn't an isolated channel but a natural extension of the communication strategy. We integrate digital communication into the global brand plan to amplify messages, strengthen the conversation with the audience and generate a coherent presence across all online environments.",
  "service.rrpp-eventos.name": "PR and Events",
  "service.rrpp-eventos.tag": "Presence people remember.",
  "service.rrpp-eventos.brief": "We design actions and events that reinforce relationships, multiply distribution and project your message more powerfully.",
  "service.rrpp-eventos.long": "Public relations extend the reach of the message and reinforce brand reputation in key environments. We design institutional relations actions, networking and event organization with personalized coordination to multiply distribution, generate valuable connections and give relevance to every initiative.",
  "service.imagen-corporativa.name": "Corporate Identity",
  "service.imagen-corporativa.tag": "Identity with character.",
  "service.imagen-corporativa.brief": "We create or redefine your visual identity so it clearly reflects the essence and value of your activity.",
  "service.imagen-corporativa.long": "A brand's image must clearly express who it is, what it offers and why it's different. We develop or renew corporate identities so they reflect the essence of your activity and project a solid, coherent and professional image across every touchpoint.",
  "service.creacion-audiovisual.name": "Video Production",
  "service.creacion-audiovisual.tag": "Stories you can see.",
  "service.creacion-audiovisual.brief": "We produce audiovisual content that connects, explains and boosts your campaigns, products and digital channels.",
  "service.creacion-audiovisual.long": "Audiovisual content is one of the most effective tools to capture attention, explain value and connect with new audiences. We create custom video pieces for companies, institutions and businesses, aimed at reinforcing campaigns, presenting services, powering social media and improving the impact of digital communication.",
  "service.publicidad-marketing.name": "Advertising and Marketing",
  "service.publicidad-marketing.tag": "Impact that converts.",
  "service.publicidad-marketing.brief": "We develop campaigns and messages aimed at maximizing visibility, awareness and commercial impact.",
  "service.publicidad-marketing.long": "We design advertising actions and marketing campaigns focused on improving reach, awareness and audience response. We define messages, creativity and channels so every campaign has strategic coherence and generates real impact on your commercial and communication goals.",
  "service.estudios-de-mercado.name": "Market Research",
  "service.estudios-de-mercado.tag": "Decide with data.",
  "service.estudios-de-mercado.brief": "We generate useful information so you understand your environment better and make strategic decisions with more certainty.",
  ...
  "page.ele.title": "Eight versions.\nOne single *instinct.*",
  "page.ele.intro": "Our character isn't a mascot: he's the visual ambassador of the brand. He changes role depending on the mission, but never his character. Strategic, close, impossible to ignore.",
  ...
  "page.ele.full.p": "Each role matches an actual agency service. Choose who you want to start the conversation with.",
  ...
  "cast.icono.role": "The Icon",
  "cast.icono.area": "Brand",
  "cast.icono.quote": "The face of it all.",
  "cast.portavoz.role": "The Spokeswoman",
  "cast.portavoz.area": "Press",
  "cast.portavoz.quote": "Speaks up for you.",
  "cast.estratega.role": "The Strategist",
  "cast.estratega.area": "Planning",
  "cast.estratega.quote": "Thinks three moves ahead.",
  "cast.anfitrion.role": "The Host",
  "cast.anfitrion.area": "Events",
  "cast.anfitrion.quote": "Owns any stage.",
  "cast.disenador.role": "The Designer (F)",
  "cast.disenador.area": "Identity",
  "cast.disenador.quote": "Detail by detail.",
  "cast.director.role": "The Director",
  "cast.director.area": "Video",
  "cast.director.quote": "Tells stories at 24 fps.",
  "cast.publicista.role": "The Publicist",
  "cast.publicista.area": "Marketing",
  "cast.publicista.quote": "Makes herself heard.",
  "cast.analista.role": "The Analyst",
  "cast.analista.area": "Data",
  "cast.analista.quote": "Nothing escapes him.",
